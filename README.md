...
Разработан и описан принцип получения программных моделей из моделей описания аппаратуры, который лег в основу разработанного программного модуля предоставляющий поддержку работы с моделями аппаратуры. На примере продемонстрирована полезность инструмента для получения и использования моделей при сквозном тестировании систем на базе фреймворка Controls.kt.
