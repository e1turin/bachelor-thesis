...
Реализовать программный модуль на языке программирования Kotin для фреймворка
"Controls.kt", предоставляющий поддержку моделирования аппаратуры на уровне
цифровых схем за счет их автоматического построения из
...
2. Документация и исходные коды проекта CIRCT и связанных с ним репозиториев.
3. Проектная работа магистратуры devtools...
4. Документация к проекту Chisel и Verilator.
...
Автоматизация процесса построения моделей аппаратуры в фреймворке Controls.kt для уже разработанных моделей приборов на языке описания аппаратуры.
...
3. Разработка программного модуля для построения моделей аппаратуры.
4. Разработка программного модуля обеспечивающего взаимодействие системы Controls-kt с разработанным модулем.
5. Тестирование разработанных модулей.
6. Документирование разработанных компонентов.

#### 1.6. перечень подлежащих разработке вопросов:

1. Архитектура SCADA-системы Controls-kt.
2. Системы моделирования аппаратуры представленные на рынке.
3. Языки описания аппаратуры (Chisel, Verilog/SystemVerilog).
4. Проект CIRCT: процесс получения исполняемых поделей, API получаемых моделей, .
5. Проект Verilator: API для взаимодействия с исполняемыми моделями.
6. API JVM для взаимодействия с нативным кодом.
7. ...
