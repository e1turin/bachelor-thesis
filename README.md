...
цифровых схем за счет автоматического их построения из
...
3. Документация к проекту Chisel и Verilator.
...
- Разработка программного модуля для построения моделей аппаратуры.
...
- Архитектура SCADA-системы Controls-kt и API для моделирования приборов.
...
- Проект Verilator: API для взаимодействия с исполняемыми моделями.
...
1.  <!-- TODO: -->
2. Описание и документация FFM API в Java из проекта Panama - https://openjdk.org/projects/panama/
