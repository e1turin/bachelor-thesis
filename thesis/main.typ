...
- `numStateBytes` --- размер в байтах необходимый для хранения состояния.
- `initialFnSym`, `finalFnSym` --- название символов в выходном нативном модуле 
...
- `offset` --- номер байта, начиная с которого располагается значение проекции 
  состояния в структуре состояния произведенной нативной модели.
